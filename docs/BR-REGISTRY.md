...
| `12-ui-ux-design` | `BR-1211` – `BR-1594` | `BR-1211` – `BR-1576` (complete, 14 of them in the `§17.2` table) · `BR-1812` – `BR-1813` · `BR-1830` – `BR-1833` (`§19.1`) | 372 | ⚠️ over-declared; `1577`–`1594` belong to `13` |
...
| Range | Status |
|---|---|
| **`BR-1834` onward** | ✅ **Next free block — use this.** Contiguous and unused. |
