...
| Range | Status |
|---|---|
| **`BR-1851` onward** | ✅ **Next free block — use this.** `BR-1843` is skipped: `10-database-design` cites it as an off-by-1000 typo for `BR-843`, and allocating it would collide with a live (if erroneous) citation. |
