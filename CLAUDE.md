...
| **Updated after** | `PH-0.1` — monorepo initialized |
...
| `PH-0.2` | Shared config package: ESLint flat config, Stylelint, Prettier | A | `0.1` | 0.5 | ⬜ | — | `pnpm lint` runs in every workspace |
...
**Progress: 1 / 28 · 3.6%** · Estimated total 19.0 d · Actual to date 0.25 d
...
*This file is how the rules survive across sessions. Update §5 at the end of every task.*
