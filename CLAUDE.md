...
| `PH-0.7`  | **VPS hardening**: SSH keys, disable root, fail2ban, ufw, unattended-upgrades                                                                                                                                           |  B   | —              |   1 |   🟡   |    0.3 | Runbook committed — awaiting founder output          |
| `PH-0.8`  | Cloudflare: DNS, proxied records, TLS, origin firewall rules                                                                                                                                                            |  B   | `0.7`          | 0.5 |   ⬜   |      — | Origin IP not publicly resolvable                    |
| `PH-0.9`  | **Coolify already installed** — verify, rotate admin credential, unbind from 0.0.0.0, firewall it, apply `08 §11.1` memory limits                                                                                       |  B   | `0.7`          | 0.5 |   ⬜   |      — | Limits declared; dashboard not on 0.0.0.0            |
...
**Progress: 18 / 28 · 64.3%** · Estimated total 19.0 d · Actual to date 8.0 d
...
| **Coolify already installed** from a provider template                                      | `PH-0.9` is not an install. See its rewritten row above.                                                                                                                                                           |
