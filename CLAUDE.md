...
| `PH-0.11` | Coolify deploy from registry + rollback by tag verification                                                                                                                                                             |  B   | `0.9`, `0.10`  | 0.5 |   ✅   |   0.55 | Deploy 5s; rollback proven both ways; 6 divergences      |
...
| `PH-0.28` | **Backups + monitoring**: daily `pg_dump` → R2, weekly restore verify, UptimeRobot, push alerts                                                                                                                         |  B   | `0.9`          |   1 |   🟡   |    0.7 | Runbook + scripts + indicator authored; founder executes |
...
**Progress: 27 / 30 · 90.0%** · Estimated total 20.5 d · Actual to date 16.6 d authored + founder execution
