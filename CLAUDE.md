...
| **Port 8000 (Coolify dashboard) is publicly reachable**                                                                     | `SB-22`, open. `PH-0.8` must close it **without an IP allow-list** — the founder's address is dynamic, and an allow-list locks them out of their clients' control panel.                                                                                                                                            |
