...
| **Current phase**  | **Phase 1 — Identity, Permissions, Money** · **7 / 32 CI-verified** (run #38) · `PH-1.5`/`PH-1.6` 🟡. Phase 0 closed at 29/30.                                                                                                                                                                |
| **Current task**   | Phase 1 — `PH-1.10` next. `PH-1.9` awaiting CI; `PH-1.5`/`PH-1.6` 🟡.                                                                                                                                                                                                                         |
