...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `SB-41`     | **Argon2id costs 161 ms on the development machine; `BR-1607` targets ~100 ms on the PRODUCTION CPU.** Production is 2 shared vCPU — slower than this box, not faster.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | The parameters are the right order of magnitude, so nothing is wrong yet. But `BR-1607` binds two ways: strong against offline attack **and** cheap enough not to become a login bottleneck on 2 vCPU (`BR-859`). If it lands at 300 ms+ on the server, every login pays it and `14 §2.3`'s rate limits interact with it. **Measure on the server before `PH-1.4` puts a login behind it**, and tune `memoryCost` first — it dominates, and lowering it costs less resistance than lowering `timeCost`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | **Before `PH-1.4` deploys**                                                                                                  |
| `SB-42`     | **The breach corpus is a 64-entry starter list, not HIBP's full set.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | The mechanism is complete: sharded by 5-hex prefix, parsing HIBP's native `HASH:COUNT` form, so the real corpus drops in with **no code change**. What is missing is data, and until it lands `BR-1609` is enforced against the 64 most common passwords rather than against 850 million. That is not nothing — it catches `password`, `123456` and `qwerty` — but it must not be read as full coverage. Load the real corpus as a deploy asset, then re-run `password.spec.ts`, which asserts `status().hashes > 0` and will keep passing either way — so **check the number, not the green**.                                                                                                                                                                                                                                                                                                                                                                                                                         | **Before public registration**                                                                                               |
