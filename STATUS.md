...
| **Current phase**  | **Phase 1 — Identity, Permissions, Money** · **6 / 32 CI-verified** (run #37) · `PH-1.5`/`PH-1.6` 🟡. Phase 0 closed at 29/30.                                                                                                                                                                |
| **Current task**   | Phase 1 — `PH-1.9` next. `PH-1.8` awaiting CI + deploy; `PH-1.5`/`PH-1.6` 🟡.                                                                                                                                                                                                                 |
...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `SB-45`     | **The 174 permission descriptions are null.** `TBL-008.description` is nullable bilingual JSONB; `05` supplies English text only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `BR-953` requires `ar` whenever the column is populated, and `BR-524` makes Arabic the source of truth. **Writing 174 machine-invented Arabic strings into a column the primary audience reads is worse than leaving it null** — it would look complete, pass every constraint, and be wrong in a way no test can detect. They land when there is a real translation. Until then the admin UI (`PH-1.13`) shows the key, which is honest and legible to an operator.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **Before `PH-1.13` ships to a non-founder admin**                                                                            |
