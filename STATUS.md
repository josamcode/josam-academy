...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `SB-41`     | **Argon2id costs 161 ms on the development machine; `BR-1607` targets ~100 ms on the PRODUCTION CPU.** Production is 2 shared vCPU — slower than this box, not faster.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | **Benchmark shipped, awaiting the server number.** Run inside the deployed API container: `sudo docker exec <API_CONTAINER> node dist/probes/argon2-bench.probe.js`. It warms up twice, samples ten, and reports mean/median/p95 — p95 rather than max, because on a shared box the slowest sample is somebody else's noise. **Record BOTH numbers: the laptop-to-server RATIO is the reusable finding**, and it calibrates every future performance estimate in this project; the absolute figure only describes today's parameters. If p95 ≥ 300 ms, lower `memoryCost` first — it dominates the cost and sacrifices less offline resistance per millisecond than `timeCost`. Do **not** touch `parallelism`: on 2 vCPU, 4 lanes already exceed what the box runs concurrently, so lowering it changes the KDF's shape rather than its cost.                                                                                                                                                                          | **Before `PH-1.4` deploys**                                                                                                  |
