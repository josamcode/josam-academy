...
| **Updated by**     | AI (founder decision recorded: `PH-1.10`'s two gaps re-owned to `PH-1.12`)                                                                                                                                                                                                                    |
| **Current phase**  | **Phase 1 — Identity, Permissions, Money** · **7 / 32 CI-verified** · `PH-1.5`/`PH-1.6` 🟡, `PH-1.10` 🟡 permanently. Phase 0 closed at 29/30.                                                                                                                                                |
...
| ----------------------- | ------: | -----: | -------------- |
| **0 — Foundation**      |      30 |     28 | 🟡 In progress |
